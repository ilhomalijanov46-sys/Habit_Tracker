    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 p-4">
            <form onSubmit={handleSubmit} className="w-full max-w-sm bg-white dark:bg-gray-800 p-8 rounded-xl shadow-sm space-y-4">
                <h1 className="text-2xl font-semibold text-center dark:text-white">Вход</h1>
                <input
                    type="email"
                    placeholder="Email"
                    value={email}
                ...
                <p className="text-center text-sm text-gray-500 dark:text-gray-400">
                    Нет аккаунта? <Link to="/register" className="text-black dark:text-white underline">Зарегистрироваться</Link>
                </p>
            </form>
        </div>
    )
